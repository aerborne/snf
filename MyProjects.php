...
//Do a a where clause for categories create a new php script for selection
 ...
 $select_all_content="select SQL_CALC_FOUND_ROWS  project_progress.projprog_id,project_progress.name,category.category_name,category.category_id,users.username,project_progress.dated,project_progress.available  FROM project_progress left join category on  project_progress.category_id = category.category_id left join users on project_progress.user_iid = users.user_iid WHERE project_progress.available = 0   and customer_id = $logged_user_id  $multi_collections order by projprog_id  DESC limit $start, $per_page  ";//sau sau sau
     ...
     <div class = "row">
        <div class = "col s3">
          ...
          <ul id='dropdown1' class='dropdown-content'>
               <li><a href="ClientMainPage.php?MyProjects">All</a></li>
                <?php 
              ...
              ?> 
            <li><a href="ClientMainPage.php?MyProjects&Category=<?php echo $category_id ?>"><?php echo $category_name; ?></a></li>
              <?php 
               } 
              ?> 
          </ul>  
...
<div class = "row" >
    <div class = "col s12 projectProgressCard" >
     <!-- Image Carousel Start  -->
              ...
              <a  href = "ClientMainPage.php?ClientViewProject=<?php echo $projprog_id;?>">View Project</a> 
           ...
           Keypress_F('SearchKeyword','LettersOnly');
               ...
               $('#submit').click(function(e){
                ...
                if($('#url_format_collection').html() == ""){
                  ...
                  window.location.replace('ClientMainPage.php?MyProjects'+'&Name='+keywordEntered); 
                }else{
                        var keywordEntered = $('#SearchKeyword').val() ;
                       keywordEntered = keywordEntered.replace(/\s/g, "+");
                   //alert(keywordEntered);
                    window.location.replace('ClientMainPage.php?MyProjects&Category='+$('#levels_value').html()+'&Name='+keywordEntered);
                }
...
<center>
  ...
  <ul class="pagination">
    ...
    <li><a href="ClientMainPage.php?ClientViewProject=1">First</a></li>
     <?php
   if($current_page==1){
    // echo "Previous";
     }else{
     echo "<li>
      <a href='ClientMainPage.php?ClientViewProject=$previous_page'&$url_format_collection aria-label='Previous'>
   ...
   if($i > 0 && $i <= $last_page){//5sau
     ...
     echo "<li><a href='ClientMainPage.php?ClientViewProject=$i'&$url_format_collection>$i</a></li>";
     }else{
   ...
   if($current_page==$last_page){
    // echo "Next";
     ...
     echo "  <li>
      <a href='ClientMainPage.php?ClientViewProject=$next_page&$url_format_collection' aria-label='Next'>
   ...
   ?>
             ...
             <li><a href="ClientMainPage.php?ClientViewProject=<?php echo $last_page; ?>">Last</a></li>
