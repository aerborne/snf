...
<div id  = "current_user_level_login" style = "display:none"><?php echo $_SESSION['user_level'];?></div>

 

         <div id = "Project" style = "display:none;"><?php echo  $projprog_id; ?></div>
          <div id = "user_id" style = "display:none;"><?php echo  $_SESSION['user_id']; ?></div>
          <div id = "user_level" style = "display:none;"><?php echo  $_SESSION['user_level'];?></div>
...
///Realtime Main Portfolio Rating Start 
     socket.emit('addUser',$user_id.html(),$username.html(),$user_level.html(),$pupdate_id.html(),'ppu',$tableName.html(),$comment_id_name.html(),$reference_id_name.html());
    ...
    socket.on('portfolio_average',function(data){
        ...
        submitComment('MainCommentBtn','MainCommentTextBox',$('#current_user_id_login').html(),$('#client_view_portfolio_id').html(),'projprog_update_comment_id','pupdate_id','projprog_update_comments',$('#client_view_portfolio_id').html()+"PORM");    
    ...
    console.log('Commented a picture');
     if (($('#pictureCommentTextBox'+variable_id).val().trim() == '')){
        ...
        //Notification for admin 
          ...
          var newCommentMessage =  " commented: "+$('#pictureCommentTextBox'+variable_id).val();
           socket.emit('NewComment NotificationPortfolio',$('#user_id').html(),$user_level.html(),newCommentMessage,'index.php?ClientViewPortfolio='+ $('#Project').html(),'comment',$('#Project').html(),function(user_id,user_level,newCommentMessage,key_id,notification_type,pupdate_id){
              }); 
