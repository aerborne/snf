...
//Do a a where clause for categories create a new php script for selection
 ...
 //echo 'start'.$per_page;
  $select_all_content="select SQL_CALC_FOUND_ROWS  category_name,category_id,available from category where available = '0' order by category_id DESC  limit $start, $per_page  ";//sau sau sau

 //echo "per page".$per_page;
 //echo "<br>start".$start;
  $run_all_content= queryMysql($select_all_content);
  $select_count="select COUNT(*) as num_row from category  where available = 0";
...
?>
            ...
            <div class="card-panel #9c27b0 purple">
                 <a href="index.php?DeletedCategory" class="btn main-color-bg  btn-block">Deleted Items</a>
            <br>
            ...
            <div class = "row">
                ...
                <tr><th>Category</th><th></th></tr>
                      ...
                      <tr>
                          ...
                          <td><a class="btn btn-default" href="admin_meta_index.php?cat_id=<?php echo $category_id;?>"><i class='large material-icons'>border_color</i></a>
...
<center>
  ...
  <ul class="pagination">
    ...
    <li><a href="admin_meta_index.php?allcategory=1">First</a></li>
     <?php
   if($current_page==1){
    // echo "Previous";
     }else{
     echo "<li>
      <a href='admin_meta_index.php?allcategory=$previous_page' aria-label='Previous'>
   ...
   if($i > 0 && $i <= $last_page){//5sau
     ...
     echo "<li><a href='admin_meta_index.php?allcategory=$i'>$i</a></li>";
     }else{
   ...
   if($current_page==$last_page){
    // echo "Next";
     ...
     echo "  <li>
      <a href='admin_meta_index.php?allcategory=$next_page' aria-label='Next'>
   ...
   ?>
             ...
             <li><a href="admin_meta_index.php?allcategory=<?php echo $last_page; ?>">Last</a></li>
