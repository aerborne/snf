     ...
     <div class = "row">
        <div class = "col s3">
          ...
          <ul id='dropdown1' class='dropdown-content'>
               <li><a href="admin_meta_index.php?allportfolio">All</a></li>
                <?php 
              ...
              ?> 
            <li><a href="admin_meta_index.php?allportfolio&category=<?php echo  strtolower ($category_id); ?>"><?php echo $category_name; ?></a></li>
              <?php 
               } 
              ?> 
          </ul>  
     ...
     <div class = "right">
                 <a class='dropdown-button  ' href='#' data-activates='allport<?php echo $projprog_id;?>'><i class="material-icons">more_vert</i></a>
                  ...
                  <ul id='allport<?php echo $projprog_id;?>' class='dropdown-content'>
                    ...
                    <li><a href="admin_meta_index.php?portfolio=<?php echo $projprog_id;?> ">Edit</a></li>
...
<div class = "row" >
    <div class = "col s12 projectProgressCard" >
     <!-- Image Carousel Start  -->
        ...
        ?>
          <a  href = "admin_meta_index.php?clientviewportfolio=<?php echo $projprog_id;?>">View Project</a> 
        <?php 
             }
          ?> 
...
else
{
         ...
         if (e.which == 13) {
               if($('#url_format_collection').html() == ""){
                  ...
                  window.location.replace('admin_meta_index.php?allportfolio'+'&name='+keywordEntered); 
                }else{
                        var keywordEntered = $('#SearchKeyword').val() ;
                       keywordEntered = keywordEntered.replace(/\s/g, "+");
                   //alert(keywordEntered);
                    window.location.replace('admin_meta_index.php?allportfolio&category='+$('#levels_value').html()+'&name='+keywordEntered);
                }
...
<center>
  ...
  <ul class="pagination">
    ...
    <li><a href="admin_meta_index.php?allportfolio=1">First</a></li>
     <?php
   if($current_page==1){
    // echo "Previous";
     }else{
     echo "<li>
      <a href='admin_meta_index.php?allportfolio=$previous_page'&$url_format_collection aria-label='Previous'>
   ...
   if($i > 0 && $i <= $last_page){//5sau
     ...
     echo "<li><a href='admin_meta_index.php?allportfolio=$i'&$url_format_collection>$i</a></li>";
     }else{
   ...
   if($current_page==$last_page){
    // echo "Next";
     ...
     echo "  <li>
      <a href='admin_meta_index.php?allportfolio=$next_page&$url_format_collection' aria-label='Next'>
   ...
   ?>
             ...
             <li><a href="admin_meta_index.php?allportfolio=<?php echo $last_page; ?>">Last</a></li>
