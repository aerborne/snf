...
<?php
if(isset($_GET['DeletedSection'])){
    $current_page=$_GET['DeletedSection'];
...
//Do a a where clause for categories create a new php script for selection
 ...
 //echo 'start'.$per_page;
  $select_all_content="select SQL_CALC_FOUND_ROWS  section_name,section_id,available from section where available = '1' order by section_id DESC  limit $start, $per_page  ";//sau sau sau

 //echo "per page".$per_page;
 //echo "<br>start".$start;
  $run_all_content= queryMysql($select_all_content);
  $select_count="select COUNT(*) as num_row from section  where available = 1";
        ...
        <script type="text/javascript">
             ...
             function ConfirmDelete(category_id,category_name){
                    if (confirm("Restore ? "+category_name)){
                        location.href='index.php?RestoreSection='+category_id;
                   }else {
...
<center>
  ...
  <ul class="pagination">
    ...
    <li><a href="index.php?DeletedSection=1">First</a></li>
     <?php
   if($current_page==1){
    // echo "Previous";
     }else{
     echo "<li>
      <a href='index.php?DeletedSection=$previous_page' aria-label='Previous'>
   ...
   if($i > 0 && $i <= $last_page){//5sau
     ...
     echo "<li><a href='index.php?DeletedSection=$i'>$i</a></li>";
     }else{
   ...
   if($current_page==$last_page){
    // echo "Next";
     ...
     echo "  <li>
      <a href='index.php?DeletedSection=$next_page' aria-label='Next'>
   ...
   ?>
             ...
             <li><a href="index.php?DeletedSection=<?php echo $last_page; ?>">Last</a></li>
